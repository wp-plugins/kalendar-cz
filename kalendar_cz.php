...
if($existuje==0){
mysql_query("CREATE TABLE ".$wpdb->prefix."plugin_websters_kalendar (id INT NOT NULL AUTO_INCREMENT, cislo INT(1) NOT NULL,typ VARCHAR(15) NOT NULL,zobrazit BOOL NOT NULL,PRIMARY KEY (id))");
...
add_action('activate_kalendar_cz/kalendar_cz.php', 'kalendar_cz_install');
...
add_action("plugins_loaded", "init_kalendar_widget");
?>